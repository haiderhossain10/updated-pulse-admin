    ...
    return (
        <>
            <div className="pt-6 md:pt-0">
                <div className="md:bg-[#FFF1F1] bg-white px-4 py-6 rounded-lg grid md:grid-cols-3 relative ">
                    ...
                    <div className="flex items-center gap-2 md:border-l md:border-l-white md:pl-6">
                        <svg
                            width={37}
                            height={37}
                            viewBox="0 0 37 37"
                    ...
                    <img
                        className="absolute bottom-0 right-4 md:h-[90%]"
                        src={HelpImg}
                    />
                </div>
            </div>
